...
### Historia de Usuario 5: Como usuario, quiero poder moverme fácilmente entre diferentes secciones de la aplicación, como el inicio, mi cuenta y las oportunidades, para navegar de manera eficiente.

- La página debe mostrar el nombre, correo electrónico y otros datos relevantes del usuario.
- El usuario debe poder acceder a esta página desde el menú principal.
...
### Historia de Usuario 8: Como usuario, quiero ver un panel de control que me muestre un resumen de mis oportunidades en seguimiento, para poder tener una visión rápida de mi progreso.
...
### Historias de Usuario 12:Como usuario, quiero ver tarjetas visuales que representen cada oportunidad en seguimiento, para poder tener una visión clara y rápida de su estado.

**Criterios de aceptación:**

- Las tarjetas deben mostrar un resumen del título, estado y fechas clave de cada oportunidad.
- Al hacer clic en una tarjeta, el usuario debe acceder a los detalles completos.
- El diseño de las tarjetas debe ser responsive para diferentes tamaños de pantalla.

---

### Historias de Usuario 13:Como usuario, quiero poder filtrar las oportunidades en seguimiento por tipo, para enfocarme solo en las que me interesan en ese momento.
...
### Historias de Usuario 15:Como usuario, quiero poder hacer scroll en la lista de oportunidades en seguimiento, para poder navegar por ellas de manera fluida sin interrupciones.
...
- Debe mantener el fondo white de el celular.
